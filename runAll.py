...
import readConfig
import common.Log
from test.HTMLTestReport import Suite

send_email = Send_email(rec=['807306906@qq.com'])
...
class AllTest:
    ...
    def __init__(self):
        global result_path
        result_path = os.path.join(path,'result','report.html')
